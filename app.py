...
if full_input_text and reference_filename:
    ...
    if not book_record:
        ...
        for q_idx, row in enumerate(raw_rows, start=1):
            ...
            # --- STRICT SEQUENTIAL RE-NUMBERING GUARANTEE (1, 2, 3, 4...) ---
            # Remove any existing erratic or skipped Q numbers generated by the LLM
            clean_item = re.sub(r"\bQ\s*\d+\.\s*", "", clean_item, flags=re.IGNORECASE)
            ...
            if "MICRO" in clean_item:
                ...
                clean_item = f"Q {q_idx}. " + clean_item
        ...
        with col3:
            ...
            st.write("✅ **Sequential Numbering:** Strictly Enforced (Q 1, Q 2, Q 3...)")
